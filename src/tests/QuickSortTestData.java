...
public class QuickSortTestData {
	...
	private static final long TEST_KEYS_S2[] = new long[] { 4, 0, 1, -1, 0, 2, -5, 0, 4 };
	private static final long SORTED_KEYS_S2[] = new long[] { -5, -1, 0, 0, 0, 1, 2, 4, 4 };
	
	private static final long TEST_KEYS_S3[] = new long[] { 0, -1000000000, 1, 500000000};
	private static final long SORTED_KEYS_S3[] = new long[] {-1000000000, 0, 1, 500000000};
